export const kingdomData = {
	...
	"krogsland": {
		...
		"cultureText":"Orc's are not accustom to a normal society and most still believe they have lost their way with stopping the war against the other races they detest as much as they detest the orcs.",
	...
	"sledge": {
		...
		"cultureText":"From the time a drawf can walk it taught to forge and to mine it comes to them as naturally as to breathe. Equal opportunity is given for all to be heard and rise with only their two hands and hard work.",
	...
	"hablo": {
		...
		"cultureText":"While never openly admitted it's Demian Aratas worst kept secret that Hablo is ruled by whoever has the most dirt on everyone else to blackmail themselves to the top.",
